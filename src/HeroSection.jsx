            ...
            <header className="absolute inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5 lg:ml-6">
                ...
                <div className="relative isolate px-6  pt-14 lg:pt-0 lg:px-8 sm:pt-14">
                    ...
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-50">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-1 text-lg font-bold leading-8 text-gray-600">
                                +254729815051
                            </p>
                            <div className="  items-center justify-center gap-x-6">
                                <a class="inline-flex items-center gap-2 justify-center rounded-md py-2 px-3 text-sm outline-offset-2 bg-gray-900 text-gray-100 group mt-3" href={pdf}>
                                    Download CV
                            ...
                            <div class="mt-6 items-center justify-center flex gap-6">

                                <a class="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/Charity-Nelima">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-purple-600 dark:fill-zinc-400 dark:group-hover:fill-purple-400">
                                ...
                                <a class="group -m-1 p-1" aria-label="Follow on LinkedIn" href="https://www.linkedin.com/in/charity-nelima/">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-purple-400"><path d="M18.335 18.339H15.67v-4.177c0-.996-.02-2.278-1.39-2.278-1.389 0-1.601 1.084-1.601 2.205v4.25h-2.666V9.75h2.56v1.17h.035c.358-.674 1.228-1.387 2.528-1.387 2.7 0 3.2 1.778 3.2 4.091v4.715zM7.003 8.575a1.546 1.546 0 01-1.548-1.549 1.548 1.548 0 111.547 1.549zm1.336 9.764H5.666V9.75H8.34v8.589zM19.67 3H4.329C3.593 3 3 3.58 3 4.297v15.406C3 20.42 3.594 21 4.328 21h15.338C20.4 21 21 20.42 21 19.703V4.297C21 3.58 20.4 3 19.666 3h.003z"></path></svg></a>
                                <a class="group -m-1 p-1" aria-label="Follow on X" href="https://x.com/CharityNelima2">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-purple-400">
                                ...
                                <a class="group -m-1 p-1" aria-label="Follow on Instagram" href="#">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-purple-400">
                                        ...
                                        <path d="M12 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6Zm0-7.622a4.622 4.622 0 1 0 0 9.244 4.622 4.622 0 0 0 0-9.244Zm5.884-.182a1.08 1.08 0 1 1-2.16 0 1.08 1.08 0 0 1 2.16 0Z"></path></svg>
                                </a>
                            </div>
                        </div>
