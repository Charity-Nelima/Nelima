                ...
                <ol class="mt-6 space-y-4">
                    <li class="flex gap-4">
                        <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
                            <img alt="" loading="lazy" width="32" height="32" decoding="async" data-nimg="1" class="h-7 w-7" src="https://spotlight.tailwindui.com/_next/static/media/planetaria.ecd81ade.svg" style={{ color: "transparent" }} />
                        </div>
                        <dl class="flex flex-auto flex-wrap gap-x-2">
                            ...
                            <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500" aria-label="2019 until Present">
                                <time datetime="2019">2019</time> <span aria-hidden="true">—</span> <time datetime="2024">Present</time>
                            </dd>
                        </dl>
                    </li>
                    <li class="flex gap-4">
                        <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
                            <img alt="" loading="lazy" width="28" height="28" decoding="async" data-nimg="1" class="h-7 w-7" src="https://spotlight.tailwindui.com/_next/static/media/airbnb.b4000690.svg" style={{ color: "transparent" }} />
                        </div>
                        <dl class="flex flex-auto flex-wrap gap-x-2">
                            <dt class="sr-only">Company</dt>
                    ...
                    <div class="flex gap-4">
                        ...
                        <li class="flex gap-4">
                            <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
                                <img alt="" loading="lazy" width="28" height="28" decoding="async" data-nimg="1" class="h-7 w-7" src="https://spotlight.tailwindui.com/_next/static/media/facebook.dd9e7d48.svg" style={{ color: "transparent" }} />
                            </div>
                            <dl class="flex flex-auto flex-wrap gap-x-2">
                                <dt class="sr-only">Company</dt>
                    ...
                    <li class="flex gap-4">
                        <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
                            <img alt="" loading="lazy" width="28" height="28" decoding="async" data-nimg="1" class="h-7 w-7" src="https://spotlight.tailwindui.com/_next/static/media/starbucks.4a5bd050.svg" style={{ color: "transparent" }} />
                        </div>
                        <dl class="flex flex-auto flex-wrap gap-x-2">
                            <dt class="sr-only">Company</dt>
